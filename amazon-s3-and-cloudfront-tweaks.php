...
class Amazon_S3_and_CloudFront_Tweaks
{
  ...
  public function __construct()
  {
     ...
     */
    // add_filter('as3cf_aws_init_client_args', [$this, 'aws_init_client_args'], 10, 1);
    // add_filter('as3cf_aws_s3_client_args', [$this, 'aws_s3_client_args'], 10, 1);
    ...
    // add_filter('as3cf_pre_upload_attachment', [$this, 'pre_upload_attachment'], 10, 3);
   ...
   */
  public function pre_update_attachment_metadata($abort, $data, $post_id, $old_provider_object)
  {
    ...
    if (is_string($extension) && in_array($extension, ['mp4', 'mov'])) {
   ...
   */
  public function pre_upload_attachment($abort, $post_id, $data)
  {
   ...
   * @return string
   */
  public function upload_acl_sizes($acl, $size, $post_id, $data)
  {
   ...
   * @return array
   */
  public function attachment_file_paths($paths, $attachment_id, $meta)
  {
  ...
  public function upload_attachment_local_files_to_remove($files_to_remove, $post_id, $file_path)
  {
    ...
    if ('path/to/file.jpg' === $file_path) {
      $files_to_remove = array_diff($files_to_remove, [$file_path]);
    }
   ...
   */
  public function cloudfront_path_parts($path_parts = [], $domain = '')
  {
   ...
   * @return int
   */
  public function calculate_batch_time($value)
  {
   ...
   * @return int
   */
  public function calculate_batch_limit($value)
  {
   ...
   * @return int
   */
  public function uploader_batch_time($value)
  {
   ...
   * @return int
   */
  public function uploader_batch_limit($value)
  {
   ...
   * @return int
   */
  public function downloader_batch_time($value)
  {
   ...
   * @return int
   */
  public function downloader_batch_limit($value)
  {
   ...
   * @return int
   */
  public function download_and_remover_batch_time($value)
  {
   ...
   * @return int
   */
  public function download_and_remover_batch_limit($value)
  {
